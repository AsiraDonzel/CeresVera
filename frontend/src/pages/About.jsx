            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 py-16 px-4 sm:px-6 lg:px-8 relative z-30 -mt-16">
                ...
                <div className="lg:w-1/4 shrink-0 space-y-3 pt-4">
                    <button
                        ...
                        className={`w-full text-left px-5 py-3 rounded-lg text-sm font-bold transition-all shadow-sm ${activeTab === 'about' ? 'bg-white border border-amber-300 text-amber-800' : 'bg-transparent border border-transparent text-gray-700 hover:bg-white/50 hover:text-amber-700'
                            }`}
                    >
                        About Us
                    </button>
                    <button
                        ...
                        className={`w-full text-left px-5 py-3 rounded-lg text-sm font-bold transition-all shadow-sm ${activeTab === 'team' ? 'bg-white border border-amber-300 text-amber-800' : 'bg-transparent border border-transparent text-gray-700 hover:bg-white/50 hover:text-amber-700'
                            }`}
                    >
                        Team Members
                    </button>
                    <button
                        ...
                        className={`w-full text-left px-5 py-3 rounded-lg text-sm font-bold transition-all shadow-sm ${activeTab === 'partners' ? 'bg-white border border-amber-300 text-amber-800' : 'bg-transparent border border-transparent text-gray-700 hover:bg-white/50 hover:text-amber-700'
                            }`}
                    >
                        Partners
                    </button>
                ...
                {/* Right Content Area */}
                <div className="lg:w-3/4 bg-white/60 backdrop-blur-md rounded-2xl p-8 sm:p-12 shadow-sm border border-sage-100">
                    <AnimatePresence mode="wait">
                        ...
                        {activeTab === 'about' && (
                            ...
                            >
                                <div>
                                    <h2 className="text-3xl font-black text-[#0F172A] mb-6">The Truth of the Harvest.</h2>
                                ...
                                {/* Callout Quote Box */}
                                <div className="bg-gradient-to-r from-amber-50 to-sage-50 border-l-4 border-amber-500 p-8 rounded-r-2xl shadow-inner relative overflow-hidden">
                                    <svg className="absolute -right-4 -top-4 w-32 h-32 text-amber-200/50 transform rotate-12" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.714 4.026-6.59 4.524-6.658l.582-.081V3h-3.41c-3.144 0-4.992 1.956-4.992 4.604v2.005H7V13.31h3.72V21h3.297z" /></svg>
                                    <h3 className="text-xl font-bold text-sage-900 mb-3 relative z-10">The "Outlier" Stewardship</h3>
                                    <p className="italic text-gray-700 text-lg relative z-10 mb-4">
                                        "The Lord God took the man and put him in the Garden of Eden to work it and take care of it."
                                    </p>
                                    <p className="text-sm font-bold text-amber-700 uppercase tracking-wider relative z-10">— Genesis 2:15</p>
                                </div>

                                <div>
                                    <h3 className="text-2xl font-bold text-[#0F172A] mb-4">What We Do</h3>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-8 items-start">
                                        <div className="flex-1">
                                            <h3 className="text-2xl font-bold text-[#0F172A] mb-4">Why We Are Different</h3>
                                        ...
                                        {/* Interswitch Badge */}
                                        <div className="sm:w-64 shrink-0 bg-white p-6 rounded-xl border border-gray-100 shadow-md flex flex-col items-center justify-center space-y-3">
                        ...
                        {activeTab === 'team' && (
                            <motion.div
                                ...
                                transition={{ duration: 0.3 }}
                            >
                                <h2 className="text-3xl font-black text-[#0F172A] mb-4">Team Members</h2>
                                ...
                                >
                                    {teamMembers.map((member, idx) => (
                                        <motion.div key={idx} variants={item} className="group">
                                            <div className="aspect-[4/5] bg-gray-200 overflow-hidden mb-4 relative rounded-xl shadow-sm">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 group-hover:text-amber-600 transition-colors">{member.name}</h3>
                                            <p className="text-sm font-medium text-sage-600 mt-1 uppercase tracking-wide">{member.role}</p>
                                        </motion.div>
                                    ))}
                                </motion.div>
                            </motion.div>
                        ...
                        {activeTab === 'partners' && (
                            ...
                            >
                                <div className="text-center mb-16">
                                    <h2 className="text-4xl font-black text-[#0F172A] tracking-tight mb-4">CeresVera: Our Partnership Ecosystem</h2>
                                    <p className="text-xl text-sage-700 font-bold uppercase tracking-widest">Built on Trust. Growing through Collaboration.</p>
                                </div>

                                <div className="max-w-4xl mx-auto space-y-16">
                                    {/* Foundational Partner: Interswitch */}
                                    <div className="bg-white rounded-[2.5rem] shadow-xl p-8 md:p-12 border border-gray-100 flex flex-col items-center text-center">
                                        <div className="mb-6">
                                            <span className="bg-sage-100 text-sage-800 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4 inline-block">Foundational Partner</span>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 mb-16">
                                        ...
                                        <div className="bg-gray-50/50 p-8 rounded-3xl border border-gray-200">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 mb-3">Agricultural Institutions & NGOs</h3>
                                        ...
                                        <div className="bg-gray-50/50 p-8 rounded-3xl border border-gray-200">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 mb-3">Certified Agronomists & Experts</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                        ...
                                        <div className="bg-gray-50/50 p-8 rounded-3xl border border-gray-200">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 mb-3">Faith-Based Organizations</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                        ...
                                        <div className="bg-gray-50/50 p-8 rounded-3xl border border-gray-200">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900 mb-3">Technology & Data Providers</h3>
                                            <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <div className="flex flex-col items-center text-center pb-12">
                                        <div className="bg-sage-50 border border-sage-200 p-8 rounded-3xl max-w-2xl mx-auto mb-10 relative overflow-hidden">
                                            ...
                                            <h3 className="text-2xl font-black text-[#0F172A] mb-4 relative z-10">"Ready to Cultivate the Future?"</h3>
                                            <p className="italic text-gray-800 text-lg relative z-10 leading-relaxed font-medium mb-6">
                                                "Two are better than one, because they have a good return for their labor: If either of them falls down, one can help the other up."
                                            </p>
                                            <p className="text-sm font-bold text-sage-700 uppercase tracking-widest relative z-10 mb-8">— Ecclesiastes 4:9-10</p>
                                            ...
                                            <Link to="/contact" className="inline-block bg-[#0F172A] hover:bg-gray-800 active:scale-95 text-white font-bold text-lg py-4 px-12 rounded-full transition-all shadow-lg shadow-gray-900/30 relative z-10">
