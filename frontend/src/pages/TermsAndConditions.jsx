                ...
                <div className="p-10 md:p-16 space-y-12">
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-2xl font-black text-gray-900">2. User Roles & Conduct</h2>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                <h3 className="text-lg font-bold text-gray-900 mb-2">Farmers</h3>
                                <p className="text-sm text-gray-600 font-medium">Responsible for providing accurate soil and crop data for diagnostics.</p>
                            </div>
                            <div className="p-6 bg-harvest-50 rounded-2xl border border-harvest-100">
                                <h3 className="text-lg font-bold text-gray-900 mb-2">Experts</h3>
                                <p className="text-sm text-gray-600 font-medium">Must maintain valid certifications. Providing false information leads to immediate loss of the Gold Veritas badge.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-2xl font-black text-gray-900">3. Payments & Escrow</h2>
                        </div>
                        <div className="space-y-4 bg-gray-50 p-8 rounded-3xl border border-gray-100">
                            <p className="text-gray-700 font-bold">CeresVera uses a Secure Escrow Model.</p>
                            ...
                            <div className="pt-4 border-t border-gray-200 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-lg font-black text-gray-900">15% Fee</p>
                                </div>
                                <div>
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-2xl font-black text-gray-900">4. AI Disclaimer</h2>
                        </div>
                        <p className="text-gray-600 leading-relaxed font-medium p-6 bg-rose-50 rounded-2xl border border-rose-100">
