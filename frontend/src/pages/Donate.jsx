                        ...
                        <div className="lg:sticky lg:top-24 space-y-8">
                            ...
                            <div>
                                ...
                                <motion.div variants={container} initial="hidden" animate="show" className="space-y-4">
                                    ...
                                    <motion.div onClick={() => { setDonationAmount(5000); setIsModalOpen(true); }} variants={item} className="group bg-white border border-gray-200 p-6 rounded-2xl hover:border-amber-400 hover:shadow-md transition-all cursor-pointer relative overflow-hidden">
                                        ...
                                        <p className="text-gray-600 text-sm leading-relaxed mb-4">Helps cover critical server and infrastructure costs for our OpenWeather integrations and local AI model hosting.</p>
                                    ...
                                    <motion.div onClick={() => { setDonationAmount(15000); setIsModalOpen(true); }} variants={item} className="group bg-white border border-gray-200 p-6 rounded-2xl hover:border-sage-400 hover:shadow-md transition-all cursor-pointer relative overflow-hidden">
                                        ...
                                        <p className="text-gray-600 text-sm leading-relaxed mb-4">Supports the physical server infrastructure needed to run our extensive PlantVillage computer vision models.</p>
                                    ...
                                    <motion.div onClick={() => { setDonationAmount(50000); setIsModalOpen(true); }} variants={item} className="group bg-[#0F172A] text-white p-6 rounded-2xl hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden">
                        ...
                        >
                            {!success ? (
                                <>
                                    ...
                                    <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-gray-50 to-white">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h2 className="text-lg font-bold text-gray-900 leading-tight">Secure Donation</h2>
                                                <p className="text-xs text-gray-500 font-medium">Powered by Interswitch</p>
                                            </div>
                                        </div>
                                        <button onClick={() => setIsModalOpen(false)} className="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 flex items-center justify-center transition-colors">
                                            <X className="w-4 h-4" />
                                        </button>
                                    </div>
                                    ...
                                    <div className="p-8">
                                        <div className="mb-6">
                                            <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Donation Amount (NGN)</label>
                                            <div className="relative">
                                                ...
                                                <input 
                                                    ...
                                                    className="w-full pl-10 pr-4 py-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-gray-50 text-xl font-bold text-gray-900" 
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <form onSubmit={handlePaymentMock} className="space-y-5">
                                            ...
                                            <div>
                                                ...
                                                <input required type="text" placeholder="e.g. JOHN DOE" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-gray-50" />
                                            </div>

                                            <div>
                                                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Card Number</label>
                                                <div className="relative">
                                                    <input required type="text" maxLength="19" placeholder="0000 0000 0000 0000" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow bg-gray-50 font-mono text-lg" />
                                ...
                                >
                                    ...
                                    <p className="text-gray-500 font-medium mb-8 text-lg">Your generous donation of ₦{Number(donationAmount).toLocaleString()} has been received.</p>
                                    <button
