"""
Django settings for crophealth project.
...
SECRET_KEY = 'django-insecure-!c@ri#&7^!#xot!qaqs5wy=ymtz($x!k1)x(ris860ts0!umy+'
...
DATABASES = {
    'default': {
        'ENGINE': 'mysql.connector.django',  # Use this for the connector
        'NAME': 'crophealth_db',
        'USER': 'root',
        'PASSWORD': 'HermonGod001',
        'HOST': '127.0.0.1',
        'PORT': '3306',
    }
}
...
# Interswitch Payment Configuration Placeholder (Hackathon Team 10)
