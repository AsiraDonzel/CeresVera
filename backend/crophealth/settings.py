...
INTERSWITCH_CLIENT_SECRET = os.environ.get('INTERSWITCH_CLIENT_SECRET', 'secret')
INTERSWITCH_CLIENT_ID = os.environ.get('INTERSWITCH_CLIENT_ID', 'IKIAB23A4E2756605C1ABC33EC3C287E27267F660D61')
